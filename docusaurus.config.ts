...
const config: Config = {
  ...
  themes: [
    [
      ...
      {
        hashed: true, // Enable cache-friendly index file names
        language: ['en'], // Support English search, add 'zh' if needed
        ...
        searchBarPosition: 'right', // Position of search bar in navbar
      },
    ],
  ],
